...
סטטוס: שער 4.0 וחבילות 4.1–4.6 הושלמו; חבילות 4.7–4.8 ממתינות לשער קליני מוגבר.
...
- חבילות 4.7–4.8: ממתינות לשער קליני מוגבר.
- יתרת התור: 42 מקורות Legacy — 8 canonical ו-34 review_required.
