...
סטטוס: שער 4.0 וחבילה 4.1 הושלמו; יתרת גל 4 מחולקת לשבע חבילות נוספות.
...
- חבילות 4.3–4.8: ממתינות לביצוע מדורג.
- יתרת התור: 88 מקורות Legacy.
- גל 4 כולו אינו מסומן כגמור עד השלמת 88 המקורות הנותרים או החלטת החרגה מתועדת עבורם.
