...
סטטוס: שער 4.0 וחבילות 4.1–4.4 הושלמו; חבילות 4.5–4.8 ממשיכות בביצוע מדורג.
...
- חבילות 4.5–4.8: ממתינות לביצוע מדורג.
- יתרת התור: 66 מקורות Legacy — 26 canonical ו-40 review_required.
