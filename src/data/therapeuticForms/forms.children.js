...
export const FORMS_CHILDREN = [
  ...
  },
  {
    ...
    audience: 'children',
    category: 'anxiety_tools',
    therapeutic_use: 'Teaches children a simple box-breathing technique to manage anxiety and stress.',
    approved: true,
    tags: ['breathing', 'anxiety', 'children', 'coping', 'relaxation'],
    recommended_for: ['children_ages_5_to_12'],
    minimum_age: 5,
    maximum_age: 12,
    requires_parent_guidance: false,
    languages: {
      en: {
        ...
        description: 'A visual guide to box breathing for children to use when feeling anxious or overwhelmed.',
      ...
      he: {
        ...
        description: 'מדריך חזותי לנשימת קופסה עבור ילדים לשימוש בעת חרדה או הצפה.',
