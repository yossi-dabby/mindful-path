...
export const FORMS_CHILDREN_CBT_PREMIUM = [
...

  {
    ...
    shortContentDescriptionHe: 'כניסה לתהליך הטיפולי עם ילד, בניית ברית טיפולית והכרה ראשונה',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מזהה מי הוא, מה חשוב לו ומה הכוחות שלו',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מזהה מתי ובאיזה מצבים הוא מרגיש קשה',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מגלה מה הוא עושה כשנתקל בקושי ומה עוזר לו',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מדרג כמה פעמים הקושי קורה וכמה הוא מפריע לחייו',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד בונה את המפה האישית שלו — קשר בין טריגרים, מחשבות, רגשות, גוף והתנהגות',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מגלה מה קרה רגע לפני שהרגיש קשה — מה הציתה את הקושי',
    languages: {
      he: {
...

  {
    ...
    childSignals: ['אני לא אצליח', 'כולם יצחקו', 'אני לא טוב', 'אני לא שווה', 'זה מסוכן', 'הוא אמר לעצמו', 'היא אמרה לעצמה', 'מה הראש אומר לו', 'לזהות מחשבה'],
    clinicalKeywords: ['מחשבה אוטומטית', 'מה הראש אמר', 'מה חשב הילד', 'מחשבות בזמן קושי', 'מחשבה בזמן קושי', 'לזהות מחשבה', 'מחשבות אוטומטיות'],
    hebrewIntentPhrases: ['מה הראש אמר לי', 'מה הילד חשב', 'מה אמר לעצמו', 'אני לא אצליח', 'כולם יצחקו עליי', 'מה הראש אומר לו', 'מה עובר לו בראש', 'מה הוא אומר לעצמו', 'לזהות מחשבה ברגע קשה', 'מה עובר לו ראש', 'מחשבה בזמן קושי', 'לזהות מה הראש אומר'],
    notFor: 'לא מתאים לבדיקת ראיות, מחשבות חלופיות, חשיפה, כלים גופניים.',
    shortContentDescriptionHe: 'הילד לומד לזהות מה הראש אמר לו בזמן הקושי — מחשבות אוטומטיות כמו \'אני לא אצליח\' או \'כולם יצחקו עליי\'',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מזהה את התחושות הפיזיות שמרגיש בגופו בזמן הקושי',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מבין מה עשה אחרי הקושי וכיצד הפעולה שלו השפיעה על המצב',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד לומד לזהות, לבדוק ולשנות מחשבות שאינן עוזרות לו',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד לומד לשים לב ולתפוס מחשבות שמגיעות אוטומטית',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד לומד להבדיל בין מחשבה (פרשנות) לבין עובדה אמיתית',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד אוסף ראיות בעד ונגד המחשבה הקשה כדי לבדוק אם היא אמיתית',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד בונה מחשבה חדשה, מאוזנת ועוזרת שתחליף את המחשבה הקשה',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד לומד להתמודד עם קשיים בפועל באמצעות חשיפה הדרגתית וניסויים התנהגותיים',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד בונה רשימה הדרגתית של מצבים שקשה לו להתמודד איתם, מהכי קל לכי קשה',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד בוחר צעד אחד קטן וניתן לביצוע להתמודדות עם הקושי',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מתכנן ומבצע ניסוי אמיץ לבדיקת מה שהמחשבה הפחידה אותו ממנו',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מזהה אילו מצבים, אנשים או מחשבות מפעילים אצלו תגובות קשות',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד בונה את ארגז הכלים האישי שלו עם כלים להרגעה, משפטים מחזקים ומיומנויות חברתיות',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מתאמן בטכניקות גופניות להרגעה — נשימה, הרפיה והרגעה חושית',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד בוחר ומאמן משפטים שיעזרו לו להרגיע את עצמו ולהתמודד בזמן קושי',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד לומד לזהות מתי הוא צריך עזרה ואיך לבקש אותה בצורה יעילה',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד לומד כיצד לפצות, להתפייס ולתקן קשר עם חבר, אח או הורה אחרי ריב',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מציין את ההצלחות שלו, מה למד ואיך ישמור על הכלים שצבר לעתיד',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מסכם מה למד על עצמו, על כוחותיו ועל דרכי ההתמודדות שלו בתהליך',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מזהה מצבים שבהם עשוי לחזור הקושי ומתכנן כיצד להתמודד',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מכין כרטיס אישי עם הכוחות, הכלים והמשפטים המחזקים שיסיים בהם את הטיפול',
    languages: {
      he: {
...

  {
    ...
    shortContentDescriptionHe: 'הילד מאשש את יכולתו להמשיך לבד עם הכלים שרכש בתהליך הטיפולי',
    languages: {
      he: {
