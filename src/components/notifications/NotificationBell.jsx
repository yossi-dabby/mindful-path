...
export default function NotificationBell() {
  ...
  if (notifications !== undefined && !Array.isArray(notifications) && process.env.NODE_ENV === 'development') {
    console.warn('[NotificationBell] notifications is not an array:', notifications);
  }
