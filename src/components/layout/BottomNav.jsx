        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex flex-col items-center justify-center gap-1 px-2 py-2 rounded-[var(--radius-control)] transition-calm border min-w-[52px]",
                isActive
            ...
            >
              ...
              <span className={cn("text-[10px] leading-none font-medium", isActive && "font-semibold")}>{item.name}</span>
            </Link>
          );
        })}
      </div>
