    ...
    <div className="md:hidden">
      ...
      <Drawer open={open} onOpenChange={setOpen} direction="left">
        <DrawerPortal>
          ...
          <DrawerContent
            data-testid="mobile-drawer" className="bg-teal-400 mt-24 rounded-t-[var(--radius-card)] inset-x-0 h-auto border border-border/70 shadow-[var(--shadow-lg)] backdrop-blur-xl fixed left-0 top-0 bottom-0 z-50 w-72 flex flex-col overflow-x-hidden border-r shadow-xl"
