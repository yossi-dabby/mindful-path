...
export default function QuickWin({ onClose }) {
  ...
  const presets = t('mind_games.content.quick_win.presets', { returnObjects: true }) || [];
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm font-medium" style={{ color: '#1A3A34' }}>
        {t('mind_games.content.quick_win.heading')}
      </p>
      ...
      <div className="flex gap-2">
        <Input
          ...
          placeholder={t('mind_games.content.quick_win.input_placeholder')}
        ...
        >
          {t('mind_games.content.quick_win.button_log')}
        </Button>
      </div>

      <p className="text-xs" style={{ color: '#5A7A72' }}>
        {t('mind_games.content.quick_win.instruction')}
      </p>
      ...
      {showSuccess && (
        <Card className="p-3 border-0" style={{
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-medium" style={{ color: '#1A3A34' }}>
              {t('mind_games.content.quick_win.success_message')}
            </p>
          </div>
        </Card>
      )}
