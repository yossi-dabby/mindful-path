...
export const gamesCatalog = [
  {
    id: "thought_quiz",
    slug: "thought-quiz",
    titleKey: "mind_games.games.thought_quiz.title",
    descriptionKey: "mind_games.games.thought_quiz.description",
    time: "60s",
    icon: "Puzzle",
  ...
  },
  {
    id: "reframe_pick",
    slug: "reframe-pick",
    titleKey: "mind_games.games.reframe_pick.title",
    descriptionKey: "mind_games.games.reframe_pick.description",
    time: "90s",
    icon: "Puzzle",
  ...
  },
  {
    id: "value_compass",
    slug: "value-compass",
    titleKey: "mind_games.games.value_compass.title",
    descriptionKey: "mind_games.games.value_compass.description",
    time: "60s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    titleKey: "mind_games.games.tiny_experiment.title",
    descriptionKey: "mind_games.games.tiny_experiment.description",
    time: "120s",
    icon: "Puzzle",
  ...
  },
  {
    id: "quick_win",
    slug: "quick-win",
    titleKey: "mind_games.games.quick_win.title",
    descriptionKey: "mind_games.games.quick_win.description",
    time: "30–60s",
    icon: "Puzzle",
  ...
  },
  {
    id: "calm_bingo",
    slug: "calm-bingo",
    titleKey: "mind_games.games.calm_bingo.title",
    descriptionKey: "mind_games.games.calm_bingo.description",
    time: "120s",
    icon: "Puzzle",
  ...
  },
  {
    id: "dbt_stop",
    slug: "dbt-stop",
    titleKey: "mind_games.games.dbt_stop.title",
    descriptionKey: "mind_games.games.dbt_stop.description",
    time: "60s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    titleKey: "mind_games.games.opposite_action.title",
    descriptionKey: "mind_games.games.opposite_action.description",
    time: "90s",
    icon: "Puzzle",
  ...
  },
  {
    id: "urge_surfing",
    slug: "urge-surfing",
    titleKey: "mind_games.games.urge_surfing.title",
    descriptionKey: "mind_games.games.urge_surfing.description",
    time: "60s",
    icon: "Puzzle",
  ...
  },
  {
    id: "worry_time",
    slug: "worry-time",
    titleKey: "mind_games.games.worry_time.title",
    descriptionKey: "mind_games.games.worry_time.description",
    time: "60s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    titleKey: "mind_games.games.evidence_balance.title",
    descriptionKey: "mind_games.games.evidence_balance.description",
    time: "120s",
    icon: "Puzzle",
  ...
  },
  {
    id: "defusion_cards",
    slug: "defusion-cards",
    titleKey: "mind_games.games.defusion_cards.title",
    descriptionKey: "mind_games.games.defusion_cards.description",
    time: "60–90s",
    icon: "Puzzle",
  ...
  },
  {
    id: "tipp_skills",
    slug: "tipp-skills",
    titleKey: "mind_games.games.tipp_skills.title",
    descriptionKey: "mind_games.games.tipp_skills.description",
    time: "2–5 min",
    icon: "Puzzle",
    componentKey: "TIPPSkills",
    testId: "mindgame-card-tipp-skills",
  },
  {
    id: "accepts",
    slug: "accepts",
    titleKey: "mind_games.games.accepts.title",
    descriptionKey: "mind_games.games.accepts.description",
    time: "60s",
    icon: "Puzzle",
    componentKey: "ACCEPTS",
    testId: "mindgame-card-accepts",
  },
  {
    id: "willing_hands",
    slug: "willing-hands",
    titleKey: "mind_games.games.willing_hands.title",
    descriptionKey: "mind_games.games.willing_hands.description",
    time: "90s",
    icon: "Puzzle",
    componentKey: "WillingHands",
    testId: "mindgame-card-willing-hands",
  },
  {
    id: "half_smile",
    slug: "half-smile",
    titleKey: "mind_games.games.half_smile.title",
    descriptionKey: "mind_games.games.half_smile.description",
    time: "60–90s",
    icon: "Puzzle",
    componentKey: "HalfSmile",
    testId: "mindgame-card-half-smile",
  },
  {
    id: "improve",
    slug: "improve",
    titleKey: "mind_games.games.improve.title",
    descriptionKey: "mind_games.games.improve.description",
    time: "60s",
    icon: "Puzzle",
    componentKey: "IMPROVE",
    testId: "mindgame-card-improve",
  },
  {
    id: "leaves_on_stream",
    slug: "leaves-on-stream",
    titleKey: "mind_games.games.leaves_on_stream.title",
    descriptionKey: "mind_games.games.leaves_on_stream.description",
    time: "60–90s",
    icon: "Puzzle",
    componentKey: "LeavesOnStream",
    testId: "mindgame-card-leaves-on-stream",
  },
  {
    id: "expansion",
    slug: "expansion",
    titleKey: "mind_games.games.expansion.title",
    descriptionKey: "mind_games.games.expansion.description",
    time: "2 min",
    icon: "Puzzle",
    componentKey: "Expansion",
    testId: "mindgame-card-expansion",
  },
  {
    id: "values_check",
    slug: "values-check",
    titleKey: "mind_games.games.values_check.title",
    descriptionKey: "mind_games.games.values_check.description",
    time: "60s",
    icon: "Puzzle",
    componentKey: "ValuesCheck",
    testId: "mindgame-card-values-check",
  },
  {
    id: "pros_and_cons",
    slug: "pros-and-cons",
    titleKey: "mind_games.games.pros_and_cons.title",
    descriptionKey: "mind_games.games.pros_and_cons.description",
    time: "2 min",
    icon: "Puzzle",
    componentKey: "ProsAndCons",
    testId: "mindgame-card-pros-and-cons",
  },
  {
    id: "check_the_facts",
    slug: "check-the-facts",
    titleKey: "mind_games.games.check_the_facts.title",
    descriptionKey: "mind_games.games.check_the_facts.description",
    time: "90s",
    icon: "Puzzle",
    componentKey: "CheckTheFacts",
    testId: "mindgame-card-check-the-facts",
  },
  {
    id: "self_soothe",
    slug: "self-soothe",
    titleKey: "mind_games.games.self_soothe.title",
    descriptionKey: "mind_games.games.self_soothe.description",
    time: "60–120s",
    icon: "Puzzle",
    componentKey: "SelfSoothe",
    testId: "mindgame-card-self-soothe",
  },
  {
    id: "mountain_meditation",
    slug: "mountain-meditation",
    titleKey: "mind_games.games.mountain_meditation.title",
    descriptionKey: "mind_games.games.mountain_meditation.description",
    time: "2 min",
    icon: "Puzzle",
    componentKey: "MountainMeditation",
    testId: "mindgame-card-mountain-meditation",
  },
];
