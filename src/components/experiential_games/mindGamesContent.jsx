...
export const gamesCatalog = [
  ...
  },
  {
    ...
    slug: "tipp-skills",
    title: "TIPP Skills",
    description: "Change body chemistry fast to reduce intensity.",
    time: "2–5 min",
    icon: "Puzzle",
  ...
  },
  {
    ...
    slug: "accepts",
    title: "ACCEPTS",
    description: "Distract from overwhelming emotions effectively.",
    time: "60s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    slug: "willing-hands",
    title: "Willing Hands",
    description: "Body-based acceptance practice.",
    time: "90s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    slug: "half-smile",
    title: "Half Smile",
    description: "Shift emotions through gentle facial expression.",
    time: "60–90s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    slug: "improve",
    title: "IMPROVE",
    description: "Improve the moment in crisis.",
    time: "60s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    title: "Leaves on Stream",
    description: "Watch thoughts float by without grabbing them.",
    time: "60–90s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    slug: "expansion",
    title: "Expansion",
    description: "Make room for difficult emotions.",
    time: "2 min",
    icon: "Puzzle",
  ...
  },
  {
    ...
    slug: "values-check",
    title: "Values Check",
    description: "Quick alignment check with your values.",
    time: "60s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    slug: "pros-and-cons",
    title: "Pros & Cons",
    description: "Wise decision-making in crisis.",
    time: "2 min",
    icon: "Puzzle",
  ...
  },
  {
    ...
    description: "Does your emotion fit the situation?",
    time: "90s",
    icon: "Puzzle",
  ...
  },
  {
    id: "self_soothe",
    slug: "self-soothe",
    title: "Self-Soothe 5 Senses",
    description: "Comfort yourself with sensory experiences.",
    time: "60–120s",
    icon: "Puzzle",
  ...
  },
  {
    ...
    description: "Embody stability and groundedness.",
    time: "2 min",
    icon: "Puzzle",
