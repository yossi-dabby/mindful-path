...
export default function ExerciseDetail({ exercise, onClose, onComplete, onToggleFavorite }) {
  ...
  return createPortal(
    <div
      ...
      <div className="px-1 py-4 min-h-full flex items-start justify-center md:items-center md:p-6">
      <motion.div
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <button
                      ...
                      onClick={() => onToggleFavorite?.(exercise)} className="bg-red-50 mb-10 ml-5 px-3 py-3 rounded-full hover:bg-white/50 transition-colors">
