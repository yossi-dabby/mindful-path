        ...
        return (
          <motion.div
            ...
            onClick={() => onSelectExercise(exercise)}>
              ...
              <CardContent className="exercise-card-art p-4 md:p-5 rounded-3xl">
                <div className="mr-8 mb-3 flex items-start justify-between">
                  <div className="bg-teal-400 text-sky-700 opacity-90 rounded-xl w-9 h-9 border border-sky-200 flex items-center justify-center group-hover:scale-110 transition-transform mx-5">
