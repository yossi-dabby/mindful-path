...
import {
  ...
  BookOpen, Dumbbell, Heart, Target, Calendar, Lock } from
'lucide-react';
            ...
            <motion.div
              ...
              <Card className="border-0" style={{
                ...
                <CardContent className="p-3 sm:p-4 text-center">
                  ...
                  <p className="text-xs font-medium" style={{ color: '#5A7A72' }}>{streak.type}</p>
                  <p className="text-gray-950 mt-1 text-xs font-medium" style={{ color: '#7A9A92' }}>Best: {streak.best}</p>
                </CardContent>
              </Card>
            </motion.div>);
                ...
                <motion.div
                  ...
                  <div
                    ...
                    style={{
                      ...
                      'rgba(200, 230, 225, 0.5)'} 0%, rgba(255, 255, 255, 0.8) 100%)` :
