{
  ...
  "quick_actions": {
    ...
    "recommended": {
      ...
      "description": "AI-tailored suggestions"
    },
  ...
  "mind_games": {
    ...
    "page_subtitle": "Quick, playful CBT/ACT/DBT micro-activities (30–120 seconds)",
  ...
  "exercises": {
    ...
    "page_subtitle": "Practice evidence-based techniques",
    "page_subtitle_full": "Practice evidence-based techniques to manage thoughts and emotions",
    ...
    "empty_state": {
      "favorites_title": "No favorite exercises yet",
      ...
      "no_exercises_message": "Exercises will be added soon to help with your practice."
    }
  },
  "journeys": {
    "page_title": "Mind Games Journeys",
    "page_subtitle": "Follow curated pathways that sequence games to build specific skills over time.",
    "tabs": {
      "available": "Available",
    ...
    "empty_state": {
      "no_available": "No journeys available. Check back soon!",
      "no_in_progress": "No journeys in progress. Start one from the Available tab!",
      "no_completed": "No completed journeys yet. Keep going!"
    }
  },
  "community": {
    "page_title": "Community",
    "page_subtitle": "Connect, share, and support each other's journeys",
    "stats": {
    ...
    "empty_state": {
      ...
      "no_groups_message": "Create the first group to bring people together!",
