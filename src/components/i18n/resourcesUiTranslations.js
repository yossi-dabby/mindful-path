...
['ai.title','Personalized resource suggestions','המלצות משאבים אישיות','Sugerencias personalizadas','Suggestions personnalisées','Persönliche Empfehlungen','Suggerimenti personalizzati','Sugestões personalizadas'],
['ai.subtitle','Choose this only when you want AI to use recent mood and journal themes to select resources from this verified library.','בחרו באפשרות זו רק אם ברצונכם שה־AI ישתמש במגמות מצב רוח ובנושאים מהיומן כדי לבחור משאבים מתוך הספרייה המאומתת.','Elige esta opción solo si quieres que la IA use tendencias recientes de ánimo y del diario para seleccionar recursos verificados.','Choisissez cette option uniquement si vous souhaitez que l’IA utilise les tendances récentes d’humeur et du journal.','Wählen Sie dies nur, wenn die KI aktuelle Stimmungs- und Tagebuchthemen für Empfehlungen verwenden darf.','Scegli questa opzione solo se vuoi che l’IA usi temi recenti di umore e diario per selezionare risorse verificate.','Escolha apenas se quiser que a IA use tendências recentes de humor e diário para selecionar recursos verificados.'],
['ai.privacy','Nothing is analyzed until you select “Get suggestions”.','לא מתבצע ניתוח עד ללחיצה על „קבלת המלצות”.','No se analiza nada hasta que selecciones «Obtener sugerencias».','Aucune analyse n’est effectuée avant de choisir « Obtenir des suggestions ».','Es wird nichts analysiert, bevor Sie „Empfehlungen erhalten“ wählen.','Non viene analizzato nulla finché non selezioni “Ricevi suggerimenti”.','Nada é analisado até selecionar “Obter sugestões”.'],
...
['ai.results_title','Suggested for you','המלצות עבורך','Sugerencias para ti','Suggestions pour vous','Für Sie empfohlen','Suggerimenti per te','Sugestões para si'],
...
['ai.show','Show personalized suggestions','הצגת המלצות אישיות','Mostrar sugerencias personalizadas','Afficher les suggestions personnalisées','Persönliche Empfehlungen anzeigen','Mostra suggerimenti personalizzati','Mostrar sugestões personalizadas'],
