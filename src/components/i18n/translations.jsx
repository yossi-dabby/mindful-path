    ...
    translation: {
      ...
      settings: {
        ...
        account: {
          ...
          delete_data_goals: "All your goals and milestones",
          delete_data_journal: "All thought journal entries",
          delete_data_conversations: "All therapy conversations",
          delete_data_progress: "All mood and progress data",
          deleting: "Deleting...",
          delete_identity_prompt: "To confirm, type your email address below:",
          delete_identity_placeholder: "Enter your email address",
          delete_identity_mismatch: "Email does not match your account",
    ...
    translation: {
      ...
      settings: {
        ...
        account: {
          ...
          delete_warning: "פעולה זו קבועה ואינה ניתנת לביטול.",
          delete_data_goals: "כל המטרות ואבני הדרך שלכם",
          delete_data_journal: "כל רשומות יומן המחשבות",
          delete_data_conversations: "כל שיחות הטיפול",
          delete_data_progress: "כל נתוני מצב הרוח וההתקדמות",
          deleting: "מוחק...",
          delete_identity_prompt: "לאישור, הקלידו את כתובת האימייל שלכם למטה:",
          delete_identity_placeholder: "הכניסו את כתובת האימייל",
          delete_identity_mismatch: "האימייל אינו תואם לחשבונכם",
    ...
    translation: {
      ...
      settings: {
        ...
        account: {
          ...
          delete_warning: "Esta acción es permanente y no se puede deshacer.",
          delete_data_goals: "Todos tus objetivos e hitos",
          delete_data_journal: "Todas las entradas del diario de pensamientos",
          delete_data_conversations: "Todas las conversaciones de terapia",
          delete_data_progress: "Todos los datos de humor y progreso",
          deleting: "Eliminando...",
          delete_identity_prompt: "Para confirmar, escribe tu dirección de correo electrónico:",
          delete_identity_placeholder: "Introduce tu correo electrónico",
          delete_identity_mismatch: "El correo electrónico no coincide con tu cuenta",
    ...
    translation: {
      ...
      settings: {
        ...
        account: {
          ...
          delete_warning: "Cette action est permanente et ne peut pas être annulée.",
          delete_data_goals: "Tous vos objectifs et jalons",
          delete_data_journal: "Toutes les entrées du journal de pensées",
          delete_data_conversations: "Toutes les conversations thérapeutiques",
          delete_data_progress: "Toutes les données d'humeur et de progrès",
          deleting: "Suppression...",
          delete_identity_prompt: "Pour confirmer, saisissez votre adresse e-mail ci-dessous :",
          delete_identity_placeholder: "Entrez votre adresse e-mail",
          delete_identity_mismatch: "L'e-mail ne correspond pas à votre compte",
    ...
    translation: {
      ...
      settings: {
        ...
        account: {
          ...
          delete_warning: "Diese Aktion ist dauerhaft und kann nicht rückgängig gemacht werden.",
          delete_data_goals: "Alle Ihre Ziele und Meilensteine",
          delete_data_journal: "Alle Gedankentagebuch-Einträge",
          delete_data_conversations: "Alle Therapiegespräche",
          delete_data_progress: "Alle Stimmungs- und Fortschrittsdaten",
          deleting: "Löschen...",
          delete_identity_prompt: "Geben Sie zur Bestätigung Ihre E-Mail-Adresse ein:",
          delete_identity_placeholder: "E-Mail-Adresse eingeben",
          delete_identity_mismatch: "E-Mail stimmt nicht mit Ihrem Konto überein",
    ...
    translation: {
      ...
      settings: {
        ...
        account: {
          ...
          delete_warning: "Questa azione è permanente e non può essere annullata.",
          delete_data_goals: "Tutti i tuoi obiettivi e traguardi",
          delete_data_journal: "Tutte le voci del diario dei pensieri",
          delete_data_conversations: "Tutte le conversazioni terapeutiche",
          delete_data_progress: "Tutti i dati sull'umore e sui progressi",
          deleting: "Eliminazione...",
          delete_identity_prompt: "Per confermare, inserisci il tuo indirizzo e-mail:",
          delete_identity_placeholder: "Inserisci il tuo indirizzo e-mail",
          delete_identity_mismatch: "L'e-mail non corrisponde al tuo account",
    ...
    translation: {
      ...
      settings: {
        ...
        account: {
          ...
          delete_warning: "Esta ação é permanente e não pode ser desfeita.",
          delete_data_goals: "Todos os seus objetivos e marcos",
          delete_data_journal: "Todas as entradas do diário de pensamentos",
          delete_data_conversations: "Todas as conversas terapêuticas",
          delete_data_progress: "Todos os dados de humor e progresso",
          deleting: "Excluindo...",
          delete_identity_prompt: "Para confirmar, digite seu endereço de e-mail abaixo:",
          delete_identity_placeholder: "Digite seu endereço de e-mail",
          delete_identity_mismatch: "E-mail não corresponde à sua conta",
