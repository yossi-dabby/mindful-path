  ...
  en: {
    translation: {
      ...
      quick_actions: {
        ...
        therapeutic_forms: { title: "Therapeutic Forms", description: "Personal practice worksheets" },
      ...
      settings: {
        ...
        data_privacy: {
          ...
          export_description: "Download a JSON copy of your account and wellness data, including AI conversation content. Internal AI reasoning, tool calls, credentials, and security-only platform metadata are excluded.",
          export_button: "Export Data",
          exporting: "Exporting...",
          delete_title: "Delete Your Account and Data",
          delete_description: "For one clear and protected deletion path, use the Delete Account section below. It requires typed confirmation and does not run from this card.",
          delete_confirm_prompt: "Are you sure? This will permanently delete all your data.",
          delete_confirm_button: "Yes, Delete All",
          deleting: "Deleting...",
          delete_button: "Go to Delete Account",
          ...
          privacy_notice: "Privacy notice: Mindful Path is a wellness and self-help service, not a medical or emergency service. Export and deletion behavior is described in the Privacy Notice. For data questions or requests, contact support@mindful-path.app."
        },
        notifications: {
          title: "Notifications",
      ...
      chat: {
        ...
        thinking: "Thinking...",
        wait: { preparing: "Preparing your response…", checking_context: "Reviewing the conversation context…", still_working: "Still working — there is no need to resend." },
        delivery: { saving: "Saving…", sent: "Sent and saved", failed: "Not saved — you can try again", failed_title: "Message not saved", failed_description: "Your draft was restored. Please try sending it again." },
        session_start: { failed_title: "Session could not start", failed_description: "The opening message was not saved. Please try starting the session again." },
        feedback: { prompt: "Was this helpful?", helpful: "Helpful", not_helpful: "Not helpful", thanks: "Thanks for your feedback!" },
        voice: { record: "Record", record_aria: "Record voice draft", recording: "Recording", stop: "Stop", stop_aria: "Stop recording", ready: "Voice draft ready", play: "Play", play_aria: "Play recording", transcribe: "Transcribe", transcribe_aria: "Transcribe recording", transcribing: "Transcribing…", delete: "Delete", delete_aria: "Delete recording" },
        experiment_metrics: { open: "Record experiment results", title: "Experiment results", anxiety_before: "Anxiety before", anxiety_after: "Anxiety after", belief_after: "Belief strength after", outcome: "What happened in practice?", learning: "What did you learn from the difference?", save: "Save results", saving: "Saving…", saved: "Results saved", failed: "Could not save. Your input is still here." },
      ...
      mood_tracker: {
        ...
        analytics: {
          ...
          range_last_2_weeks: "Last 2 weeks",
          ...
          shift: "Shift",
          steady: "Steady",
          mood_stress_levels: "Mood & Stress Levels",
          mood_series: "Mood (1–5)",
          stress_series: "Stress (1–10)",
          energy_intensity: "Energy & Intensity",
          energy: "Energy",
          intensity: "Intensity",
          start_tracking: "Start tracking your mood to see trigger analysis",
          triggers_title: "Mood Triggers",
          triggers_subtitle: "What negatively affects your mood",
          no_trigger_data: "No trigger data yet",
          boosters_title: "Mood Boosters",
          boosters_subtitle: "Activities that improve your mood",
          no_activity_data: "No activity data yet",
          emotional_patterns: "Emotional Patterns",
          emotional_patterns_subtitle: "Most frequently experienced emotions",
          no_emotion_data: "No emotion data yet",
          average_mood_value: "Avg Mood: {{value}}/5",
      ...
      goal_coach_wizard: {
        ...
        smart_relevant_placeholder: "Relevant: Why does this goal matter now?",
      ...
      exercise_view: {
        ...
        step_duration: "Duration: {{seconds}} seconds",
        instructions: "Instructions",
        instructions_soon: "Instructions will appear here soon.",
        choose_duration: "Choose Duration",
        minutes_short: "{{count}} min",
        key_benefits: "Key Benefits",
        benefits_fallback: "This exercise helps improve mental well-being, reduce stress, and enhance emotional regulation.",
        helpful_tips: "Helpful Tips",
        tips_fallback: "Practice regularly for best results. Find a quiet space, start slowly, and be patient with yourself.",
        your_progress: "Your Progress",
        times_completed: "Times Completed",
        minutes_practiced: "Minutes Practiced",
        last_practiced: "Last practiced: {{date}}",
      ...
      therapeutic_forms: {
        card_title: "Therapeutic Forms",
        card_subtitle: "Personal practice worksheets",
        page_title: "Therapeutic Forms",
        page_subtitle: "Browse and download personal practice worksheets",
        ...
        category: {
          ...
          children_cbt_core: "Children CBT Core",
          children_cbt_specialized: "Children CBT Specialized",
  ...
  he: {
    translation: {
      ...
      quick_actions: {
        ...
        therapeutic_forms: { title: "טפסים טיפוליים", description: "דפי עבודה לתרגול אישי" },
      ...
      settings: {
        ...
        data_privacy: {
          ...
          export_description: "הורידו עותק JSON של נתוני החשבון והרווחה שלכם, כולל תוכן שיחות AI. הנמקה פנימית של ה-AI, קריאות לכלים, פרטי גישה ומטא-נתוני אבטחה פנימיים אינם נכללים.",
          export_button: "ייצוא נתונים",
          exporting: "מייצא...",
          delete_title: "מחיקת החשבון והנתונים",
          delete_description: "כדי לשמור על מסלול מחיקה ברור ומוגן אחד, השתמשו באזור מחיקת החשבון שבהמשך הדף. הפעולה דורשת הקלדת אישור ואינה מתבצעת מכרטיס זה.",
          delete_confirm_prompt: "האם אתם בטוחים? פעולה זו תמחק לצמיתות את כל הנתונים שלכם.",
          delete_confirm_button: "כן, מחקו הכל",
          deleting: "מוחק...",
          delete_button: "מעבר למחיקת החשבון",
          cancel_button: "ביטול",
          ...
          privacy_notice: "הודעת פרטיות: Mindful Path הוא שירות לרווחה ולעזרה עצמית, ואינו שירות רפואי או שירות חירום. אופן הייצוא והמחיקה מפורט בהודעת הפרטיות. לשאלות או בקשות בנושא נתונים: support@mindful-path.app."
        },
        notifications: {
          title: "התראות",
      ...
      chat: {
        ...
        thinking: "חושב...",
        wait: { preparing: "מכין תשובה…", checking_context: "בודק את הקשר השיחה…", still_working: "עדיין עובד — אין צורך לשלוח שוב." },
        delivery: { saving: "שומר…", sent: "נשלח ונשמר", failed: "לא נשמר — אפשר לנסות שוב", failed_title: "ההודעה לא נשמרה", failed_description: "הטיוטה שוחזרה. אפשר לנסות לשלוח אותה שוב." },
        session_start: { failed_title: "לא ניתן להתחיל את המפגש", failed_description: "הודעת הפתיחה לא נשמרה. נסו להתחיל את המפגש שוב." },
        feedback: { prompt: "האם זה עזר?", helpful: "עזר", not_helpful: "לא עזר", thanks: "תודה על המשוב!" },
        voice: { record: "הקלטה", record_aria: "הקלטת טיוטה קולית", recording: "מקליט", stop: "עצירה", stop_aria: "עצירת ההקלטה", ready: "הטיוטה הקולית מוכנה", play: "השמעה", play_aria: "השמעת ההקלטה", transcribe: "תמלול", transcribe_aria: "תמלול ההקלטה", transcribing: "מתמלל…", delete: "מחיקה", delete_aria: "מחיקת ההקלטה" },
        experiment_metrics: { open: "תיעוד תוצאות הניסוי", title: "תוצאות הניסוי", anxiety_before: "חרדה לפני", anxiety_after: "חרדה אחרי", belief_after: "עוצמת האמונה אחרי", outcome: "מה קרה בפועל?", learning: "מה למדת מהפער?", save: "שמירת התוצאות", saving: "שומר…", saved: "התוצאות נשמרו", failed: "השמירה נכשלה. הקלט שלך נשאר כאן." },
      ...
      mood_tracker: {
        ...
        analytics: {
          range_last_7_days: "7 הימים האחרונים",
          range_last_2_weeks: "השבועיים האחרונים",
          range_last_month: "החודש האחרון",
          range_last_3_months: "3 החודשים האחרונים",
          date_range: "טווח תאריכים",
          average_mood: "מצב רוח ממוצע",
          average_stress: "לחץ ממוצע",
          no_data_yet: "אין עדיין נתונים",
          trend: "מגמה",
          better: "שיפור",
          shift: "שינוי",
          steady: "יציב",
          mood_stress_levels: "רמות מצב רוח ולחץ",
          mood_series: "מצב רוח (1–5)",
          stress_series: "לחץ (1–10)",
          energy_intensity: "אנרגיה ועוצמה",
          energy: "אנרגיה",
          intensity: "עוצמה",
          start_tracking: "התחילו לעקוב אחר מצב הרוח כדי לראות ניתוח גורמים משפיעים",
          triggers_title: "גורמים המשפיעים על מצב הרוח",
          triggers_subtitle: "מה משפיע לרעה על מצב הרוח",
          no_trigger_data: "אין עדיין נתוני גורמים",
          boosters_title: "משפרי מצב רוח",
          boosters_subtitle: "פעילויות שמשפרות את מצב הרוח",
          no_activity_data: "אין עדיין נתוני פעילויות",
          emotional_patterns: "דפוסים רגשיים",
          emotional_patterns_subtitle: "הרגשות הנחווים בתדירות הגבוהה ביותר",
          no_emotion_data: "אין עדיין נתוני רגשות",
          average_mood_value: "מצב רוח ממוצע: {{value}}/5",
          times_count: "{{count}} פעמים"
        },
        form: {
      ...
      goal_coach_wizard: {
        ...
        smart_relevant_placeholder: "רלוונטי: מדוע המטרה הזו חשובה עכשיו?",
      ...
      exercise_view: {
        ...
        close: "סגירה",
        about: "על התרגיל",
        guided_visualization: "דמיון מודרך",
        video_demo: "הדגמת וידאו",
        audio_guide: "מדריך קולי",
        audio_unsupported: "הדפדפן שלך אינו תומך בניגון שמע.",
        helps_with: "מסייע בהתמודדות עם",
        guided_audio: "הדרכה קולית",
        guided_audio_description: "אפשר לעקוב אחר ההדרכה הקולית המקצועית לאורך התרגיל.",
        step_guide: "מדריך שלב אחר שלב",
        step_duration: "משך: {{seconds}} שניות",
        instructions: "הוראות",
        instructions_soon: "ההוראות יופיעו כאן בקרוב.",
        choose_duration: "בחירת משך",
        minutes_short: "{{count}} דק׳",
        key_benefits: "יתרונות מרכזיים",
        benefits_fallback: "התרגיל מסייע לשיפור הרווחה הנפשית, להפחתת מתח ולחיזוק הוויסות הרגשי.",
        helpful_tips: "טיפים מועילים",
        tips_fallback: "כדאי לתרגל בקביעות, למצוא מקום שקט, להתחיל בהדרגה ולגלות סבלנות כלפי עצמך.",
        your_progress: "ההתקדמות שלך",
        times_completed: "מספר השלמות",
        minutes_practiced: "דקות תרגול",
        last_practiced: "תרגול אחרון: {{date}}",
      ...
      therapeutic_forms: {
        card_title: "טפסים טיפוליים",
        card_subtitle: "דפי עבודה לתרגול אישי",
        page_title: "טפסים טיפוליים",
        page_subtitle: "עיינו והורידו דפי עבודה לתרגול אישי",
        ...
        category: {
          all: "כל הקטגוריות",
          thought_records: "רשומות מחשבה",
          cognitive_distortions: "עיוותי חשיבה",
          emotional_regulation: "ויסות רגשי",
          behavioral_activation: "הפעלה התנהגותית",
          anxiety_tools: "כלי חרדה",
          depression_tools: "כלי דיכאון",
          anger_management: "ניהול כעס",
          social_skills: "מיומנויות חברתיות",
          sleep: "שינה",
          goals_and_values: "מטרות וערכים",
          parent_guidance: "הדרכת הורים",
          caregiver_support: "תמיכת מטפלים",
          ...
          children_cbt_specialized: "CBT ייעודי לילדים",
  ...
  es: {
    translation: {
      ...
      quick_actions: {
        ...
        therapeutic_forms: { title: "Formularios Terapéuticos", description: "Hojas de trabajo para práctica personal" },
      ...
      chat: {
        ...
        thinking: "Pensando...",
        wait: { preparing: "Preparando tu respuesta…", checking_context: "Revisando el contexto de la conversación…", still_working: "Sigo trabajando; no hace falta volver a enviarlo." },
        delivery: { saving: "Guardando…", sent: "Enviado y guardado", failed: "No se guardó; puedes intentarlo de nuevo", failed_title: "El mensaje no se guardó", failed_description: "Tu borrador se restauró. Intenta enviarlo de nuevo." },
        session_start: { failed_title: "No se pudo iniciar la sesión", failed_description: "El mensaje inicial no se guardó. Intenta iniciar la sesión de nuevo." },
        feedback: { prompt: "¿Te resultó útil?", helpful: "Útil", not_helpful: "No fue útil", thanks: "¡Gracias por tus comentarios!" },
        voice: { record: "Grabar", record_aria: "Grabar borrador de voz", recording: "Grabando", stop: "Detener", stop_aria: "Detener grabación", ready: "Borrador de voz listo", play: "Reproducir", play_aria: "Reproducir grabación", transcribe: "Transcribir", transcribe_aria: "Transcribir grabación", transcribing: "Transcribiendo…", delete: "Eliminar", delete_aria: "Eliminar grabación" },
        experiment_metrics: { open: "Registrar resultados del experimento", title: "Resultados del experimento", anxiety_before: "Ansiedad antes", anxiety_after: "Ansiedad después", belief_after: "Intensidad de la creencia después", outcome: "¿Qué ocurrió en la práctica?", learning: "¿Qué aprendiste de la diferencia?", save: "Guardar resultados", saving: "Guardando…", saved: "Resultados guardados", failed: "No se pudo guardar. Tu texto sigue aquí." },
      ...
      mood_tracker: {
        ...
        analytics: {
          ...
          range_last_2_weeks: "Últimas 2 semanas",
          range_last_month: "Último mes",
          range_last_3_months: "Últimos 3 meses",
          date_range: "Rango de fechas",
          average_mood: "Estado de ánimo promedio",
          average_stress: "Estrés promedio",
          no_data_yet: "Aún no hay datos",
          trend: "Tendencia",
          better: "Mejor",
          shift: "Cambio",
          steady: "Estable",
          mood_stress_levels: "Niveles de ánimo y estrés",
          mood_series: "Ánimo (1–5)",
          stress_series: "Estrés (1–10)",
          energy_intensity: "Energía e intensidad",
          energy: "Energía",
          intensity: "Intensidad",
          start_tracking: "Comienza a registrar tu estado de ánimo para ver el análisis de factores",
          triggers_title: "Factores del estado de ánimo",
          triggers_subtitle: "Lo que afecta negativamente tu estado de ánimo",
          no_trigger_data: "Aún no hay datos de factores",
          boosters_title: "Impulsores del ánimo",
          boosters_subtitle: "Actividades que mejoran tu estado de ánimo",
          no_activity_data: "Aún no hay datos de actividades",
          emotional_patterns: "Patrones emocionales",
          emotional_patterns_subtitle: "Emociones experimentadas con mayor frecuencia",
          no_emotion_data: "Aún no hay datos de emociones",
          average_mood_value: "Ánimo promedio: {{value}}/5",
          times_count: "{{count}} veces"
        },
        form: {
      ...
      goal_coach_wizard: {
        ...
        smart_relevant_placeholder: "Relevante: ¿Por qué importa esta meta ahora?",
      ...
      exercise_view: {
        ...
        guided_visualization: "Visualización guiada",
        video_demo: "Demostración en vídeo",
        audio_guide: "Guía de audio",
        audio_unsupported: "Tu navegador no admite el elemento de audio.",
        helps_with: "Ayuda con",
        guided_audio: "Audio guiado",
        guided_audio_description: "Sigue la guía de audio narrada profesionalmente para este ejercicio.",
        ...
        step_duration: "Duración: {{seconds}} segundos",
        instructions: "Instrucciones",
        instructions_soon: "Las instrucciones aparecerán aquí pronto.",
        choose_duration: "Elegir duración",
        minutes_short: "{{count}} min",
        key_benefits: "Beneficios principales",
        benefits_fallback: "Este ejercicio ayuda a mejorar el bienestar mental, reducir el estrés y fortalecer la regulación emocional.",
        helpful_tips: "Consejos útiles",
        tips_fallback: "Practica con regularidad. Busca un lugar tranquilo, empieza poco a poco y ten paciencia contigo.",
        your_progress: "Tu progreso",
        times_completed: "Veces completado",
        minutes_practiced: "Minutos practicados",
        last_practiced: "Última práctica: {{date}}",
      ...
      therapeutic_forms: {
        card_title: "Formularios Terapéuticos",
        card_subtitle: "Hojas de trabajo para práctica personal",
        page_title: "Formularios Terapéuticos",
        page_subtitle: "Navega y descarga hojas de trabajo para práctica personal",
        ...
        category: {
          ...
          thought_records: "Registros de pensamientos",
          cognitive_distortions: "Distorsiones cognitivas",
          emotional_regulation: "Regulación emocional",
          behavioral_activation: "Activación conductual",
          anxiety_tools: "Herramientas de ansiedad",
          depression_tools: "Herramientas de depresión",
          anger_management: "Control de ira",
          social_skills: "Habilidades sociales",
          sleep: "Sueño",
          goals_and_values: "Metas y valores",
          parent_guidance: "Orientación para padres",
          caregiver_support: "Apoyo al cuidador",
          ...
          adolescents_cbt_core: "CBT central para adolescentes",
  ...
  fr: {
    translation: {
      ...
      quick_actions: {
        ...
        therapeutic_forms: { title: "Formulaires Thérapeutiques", description: "Fiches de travail pour la pratique personnelle" },
      ...
      chat: {
        ...
        wait: { preparing: "Préparation de votre réponse…", checking_context: "Vérification du contexte de la conversation…", still_working: "Toujours en cours — inutile de renvoyer le message." },
        delivery: { saving: "Enregistrement…", sent: "Envoyé et enregistré", failed: "Non enregistré — vous pouvez réessayer", failed_title: "Message non enregistré", failed_description: "Votre brouillon a été restauré. Veuillez réessayer." },
        session_start: { failed_title: "Impossible de démarrer la séance", failed_description: "Le message d’ouverture n’a pas été enregistré. Veuillez réessayer." },
        feedback: { prompt: "Cela vous a-t-il aidé ?", helpful: "Utile", not_helpful: "Pas utile", thanks: "Merci pour votre retour !" },
        voice: { record: "Enregistrer", record_aria: "Enregistrer un brouillon vocal", recording: "Enregistrement", stop: "Arrêter", stop_aria: "Arrêter l’enregistrement", ready: "Brouillon vocal prêt", play: "Lire", play_aria: "Lire l’enregistrement", transcribe: "Transcrire", transcribe_aria: "Transcrire l’enregistrement", transcribing: "Transcription…", delete: "Supprimer", delete_aria: "Supprimer l’enregistrement" },
        experiment_metrics: { open: "Noter les résultats de l’expérience", title: "Résultats de l’expérience", anxiety_before: "Anxiété avant", anxiety_after: "Anxiété après", belief_after: "Force de la croyance après", outcome: "Que s’est-il passé en pratique ?", learning: "Qu’avez-vous appris de l’écart ?", save: "Enregistrer", saving: "Enregistrement…", saved: "Résultats enregistrés", failed: "Échec de l’enregistrement. Votre texte est conservé." },
      ...
      mood_tracker: {
        ...
        analytics: {
          ...
          range_last_2_weeks: "2 dernières semaines",
          range_last_month: "Mois dernier",
          range_last_3_months: "3 derniers mois",
          date_range: "Période",
          average_mood: "Humeur moyenne",
          average_stress: "Stress moyen",
          no_data_yet: "Aucune donnée pour le moment",
          trend: "Tendance",
          better: "Mieux",
          shift: "Changement",
          steady: "Stable",
          mood_stress_levels: "Niveaux d’humeur et de stress",
          mood_series: "Humeur (1–5)",
          stress_series: "Stress (1–10)",
          energy_intensity: "Énergie et intensité",
          energy: "Énergie",
          intensity: "Intensité",
          start_tracking: "Commencez à suivre votre humeur pour voir l’analyse des facteurs",
          triggers_title: "Facteurs d’humeur",
          triggers_subtitle: "Ce qui affecte négativement votre humeur",
          no_trigger_data: "Aucune donnée sur les facteurs",
          boosters_title: "Améliorateurs d’humeur",
          boosters_subtitle: "Activités qui améliorent votre humeur",
          no_activity_data: "Aucune donnée sur les activités",
          emotional_patterns: "Schémas émotionnels",
          emotional_patterns_subtitle: "Émotions ressenties le plus fréquemment",
          no_emotion_data: "Aucune donnée sur les émotions",
          average_mood_value: "Humeur moyenne : {{value}}/5",
          times_count: "{{count}} fois"
        },
        form: {
      ...
      goal_coach_wizard: {
        ...
        smart_relevant_placeholder: "Pertinent : Pourquoi cet objectif compte-t-il maintenant ?",
      ...
      exercise_view: {
        ...
        about: "À propos de cet exercice",
        guided_visualization: "Visualisation guidée",
        video_demo: "Démonstration vidéo",
        audio_guide: "Guide audio",
        audio_unsupported: "Votre navigateur ne prend pas en charge l’élément audio.",
        helps_with: "Aide pour",
        guided_audio: "Audio guidé",
        guided_audio_description: "Suivez le guide audio narré par un professionnel pour cet exercice.",
        step_guide: "Guide étape par étape",
        step_duration: "Durée : {{seconds}} secondes",
        instructions: "Instructions",
        instructions_soon: "Les instructions apparaîtront bientôt ici.",
        choose_duration: "Choisir la durée",
        minutes_short: "{{count}} min",
        key_benefits: "Principaux bénéfices",
        benefits_fallback: "Cet exercice aide à améliorer le bien-être mental, à réduire le stress et à renforcer la régulation émotionnelle.",
        helpful_tips: "Conseils utiles",
        tips_fallback: "Pratiquez régulièrement. Trouvez un endroit calme, commencez doucement et soyez patient avec vous-même.",
        your_progress: "Votre progression",
        times_completed: "Nombre de réalisations",
        minutes_practiced: "Minutes pratiquées",
        last_practiced: "Dernière pratique : {{date}}",
      ...
      therapeutic_forms: {
        card_title: "Formulaires Thérapeutiques",
        card_subtitle: "Fiches de travail pour la pratique personnelle",
        page_title: "Formulaires Thérapeutiques",
        page_subtitle: "Parcourez et téléchargez des fiches de travail pour la pratique personnelle",
        filter_audience: "Audience",
        ...
        audience: {
          ...
          adolescents: "Adolescents",
          adults: "Adultes",
          older_adults: "Personnes âgées",
        },
        category: {
          all: "Toutes les catégories",
          thought_records: "Journaux de pensées",
          cognitive_distortions: "Distorsions cognitives",
          emotional_regulation: "Régulation émotionnelle",
          behavioral_activation: "Activation comportementale",
          anxiety_tools: "Outils d'anxiété",
          depression_tools: "Outils de dépression",
          anger_management: "Gestion de la colère",
          social_skills: "Compétences sociales",
          sleep: "Sommeil",
          goals_and_values: "Objectifs et valeurs",
          ...
          adolescents_cbt_core: "TCC de base pour adolescents",
  ...
  de: {
    translation: {
      ...
      quick_actions: {
        ...
        therapeutic_forms: { title: "Therapeutische Formulare", description: "Arbeitsblätter für die persönliche Praxis" },
      ...
      chat: {
        ...
        thinking: "Nachdenken...",
        wait: { preparing: "Antwort wird vorbereitet…", checking_context: "Gesprächskontext wird geprüft…", still_working: "Noch in Arbeit — Sie müssen nichts erneut senden." },
        delivery: { saving: "Wird gespeichert…", sent: "Gesendet und gespeichert", failed: "Nicht gespeichert — erneut versuchen", failed_title: "Nachricht nicht gespeichert", failed_description: "Ihr Entwurf wurde wiederhergestellt. Bitte erneut senden." },
        session_start: { failed_title: "Sitzung konnte nicht gestartet werden", failed_description: "Die Eröffnungsnachricht wurde nicht gespeichert. Bitte erneut versuchen." },
        feedback: { prompt: "War das hilfreich?", helpful: "Hilfreich", not_helpful: "Nicht hilfreich", thanks: "Danke für Ihr Feedback!" },
        voice: { record: "Aufnehmen", record_aria: "Sprachentwurf aufnehmen", recording: "Aufnahme", stop: "Stopp", stop_aria: "Aufnahme stoppen", ready: "Sprachentwurf bereit", play: "Abspielen", play_aria: "Aufnahme abspielen", transcribe: "Transkribieren", transcribe_aria: "Aufnahme transkribieren", transcribing: "Wird transkribiert…", delete: "Löschen", delete_aria: "Aufnahme löschen" },
        experiment_metrics: { open: "Ergebnisse des Experiments erfassen", title: "Ergebnisse des Experiments", anxiety_before: "Angst vorher", anxiety_after: "Angst nachher", belief_after: "Überzeugungsstärke nachher", outcome: "Was ist tatsächlich passiert?", learning: "Was haben Sie aus dem Unterschied gelernt?", save: "Ergebnisse speichern", saving: "Wird gespeichert…", saved: "Ergebnisse gespeichert", failed: "Speichern fehlgeschlagen. Ihre Eingabe bleibt erhalten." },
      ...
      journeys: {
        ...
        premium: {
          eyebrow: "Ihre geführte Praxis",
          hero_description: "Wählen Sie einen ruhigen, strukturierten Weg und gehen Sie Schritt für Schritt vor.",
          back_aria: "Zurück zur Startseite",
          summary_aria: "Reiseübersicht",
          stat_available: "Verfügbar",
          stat_active: "Aktiv",
          stat_completed: "Abgeschlossen",
          loading: "Ihre Reisen werden vorbereitet...",
          load_error_title: "Ihre Reisen konnten nicht geladen werden",
          load_error_description: "Ihr Fortschritt ist sicher. Prüfen Sie die Verbindung und versuchen Sie es erneut.",
          retry: "Erneut versuchen",
          start_error: "Die Reise konnte nicht gestartet werden. Versuchen Sie es erneut.",
          starting: "Wird gestartet...",
          empty_available_description: "Neue geführte Wege erscheinen hier, sobald sie verfügbar sind.",
          empty_active_description: "Wählen Sie eine verfügbare Reise, wenn Sie bereit sind.",
          empty_completed_description: "Abgeschlossene Reisen werden hier als Verlauf Ihrer Praxis gesammelt.",
          gentle_pace: "Gehen Sie in Ihrem Tempo — jeder Schritt zählt.",
          card_badge: "Geführter Weg",
          explore: "Reisen entdecken",
          detail_eyebrow: "Ihre Reise",
          roadmap_description: "Schließen Sie den aktuellen Schritt ab, um den nächsten behutsam freizuschalten.",
        ...
        categories: {
          anxiety: "Unterstützung bei Angst",
          depression: "Unterstützung bei Tiefstimmung",
          stress: "Stressabbau",
          distress_tolerance: "Stresstoleranz",
          emotion_regulation: "Emotionsregulation",
          mindfulness: "Achtsamkeit",
          other: "Persönliches Wachstum"
        },
        difficulties: {
          beginner: "Sanft",
          intermediate: "Aufbauend",
        ...
        card: {
          ...
          continue_journey: "Fortsetzen",
          view_details: "Details anzeigen",
          details_aria: "Reisedetails"
        },
        detail: {
          what_youll_gain: "Was Sie entwickeln",
          journey_steps: "Reiseschritte",
          day: "Tag",
          play_game: "Übung öffnen",
          current_step: "Aktuell",
          locked_step: "Gesperrt",
          completed_step: "Abgeschlossen",
          reflection_placeholder: "Schreiben Sie ein paar Worte, wenn Sie möchten",
          reflection_hint: "Optional und privat in Ihrem Konto.",
          saving: "Speichern...",
          mark_complete: "Schritt abschließen",
          save_error: "Dieser Schritt konnte nicht gespeichert werden. Ihr bisheriger Fortschritt ist sicher; versuchen Sie es erneut.",
          close_aria: "Reisedetails schließen"
        }
      },
      mood_tracker: {
        ...
        analytics: {
          ...
          range_last_2_weeks: "Letzte 2 Wochen",
          range_last_month: "Letzter Monat",
          range_last_3_months: "Letzte 3 Monate",
          date_range: "Zeitraum",
          average_mood: "Durchschnittliche Stimmung",
          average_stress: "Durchschnittlicher Stress",
          no_data_yet: "Noch keine Daten",
          trend: "Trend",
          better: "Besser",
          shift: "Veränderung",
          steady: "Stabil",
          mood_stress_levels: "Stimmungs- und Stressniveau",
          mood_series: "Stimmung (1–5)",
          stress_series: "Stress (1–10)",
          energy_intensity: "Energie und Intensität",
          energy: "Energie",
          intensity: "Intensität",
          start_tracking: "Beginnen Sie mit der Stimmungserfassung, um Einflussfaktoren zu sehen",
          triggers_title: "Stimmungsauslöser",
          triggers_subtitle: "Was Ihre Stimmung negativ beeinflusst",
          no_trigger_data: "Noch keine Auslöserdaten",
          boosters_title: "Stimmungsaufheller",
          boosters_subtitle: "Aktivitäten, die Ihre Stimmung verbessern",
          no_activity_data: "Noch keine Aktivitätsdaten",
          emotional_patterns: "Emotionale Muster",
          emotional_patterns_subtitle: "Am häufigsten erlebte Emotionen",
          no_emotion_data: "Noch keine Emotionsdaten",
          average_mood_value: "Ø Stimmung: {{value}}/5",
          times_count: "{{count}} Mal"
        },
        form: {
      ...
      goal_coach_wizard: {
        ...
        smart_relevant_placeholder: "Relevant: Warum ist dieses Ziel jetzt wichtig?",
      ...
      exercise_view: {
        ...
        about: "Über diese Übung",
        guided_visualization: "Geführte Visualisierung",
        video_demo: "Videodemonstration",
        audio_guide: "Audioanleitung",
        audio_unsupported: "Ihr Browser unterstützt das Audioelement nicht.",
        helps_with: "Hilft bei",
        guided_audio: "Geführtes Audio",
        guided_audio_description: "Folgen Sie der professionell gesprochenen Audioanleitung für diese Übung.",
        step_guide: "Schritt-für-Schritt-Anleitung",
        step_duration: "Dauer: {{seconds}} Sekunden",
        instructions: "Anweisungen",
        instructions_soon: "Die Anweisungen erscheinen hier in Kürze.",
        choose_duration: "Dauer wählen",
        minutes_short: "{{count}} Min.",
        key_benefits: "Wichtigste Vorteile",
        benefits_fallback: "Diese Übung verbessert das psychische Wohlbefinden, reduziert Stress und stärkt die Emotionsregulation.",
        helpful_tips: "Hilfreiche Tipps",
        tips_fallback: "Üben Sie regelmäßig. Suchen Sie einen ruhigen Ort, beginnen Sie langsam und seien Sie geduldig mit sich.",
        your_progress: "Ihr Fortschritt",
        times_completed: "Abgeschlossen",
        minutes_practiced: "Geübte Minuten",
        last_practiced: "Zuletzt geübt: {{date}}",
      ...
      therapeutic_forms: {
        card_title: "Therapeutische Formulare",
        card_subtitle: "Arbeitsblätter für die persönliche Praxis",
        page_title: "Therapeutische Formulare",
        page_subtitle: "Arbeitsblätter für die persönliche Praxis durchsuchen und herunterladen",
        ...
        category: {
          all: "Alle Kategorien",
          thought_records: "Gedankenprotokolle",
          cognitive_distortions: "Kognitive Verzerrungen",
          emotional_regulation: "Emotionsregulation",
          behavioral_activation: "Verhaltensaktivierung",
          anxiety_tools: "Angst-Werkzeuge",
          depression_tools: "Depressions-Werkzeuge",
          anger_management: "Ärgermanagement",
          social_skills: "Soziale Kompetenzen",
          sleep: "Schlaf",
          goals_and_values: "Ziele & Werte",
          parent_guidance: "Elternberatung",
          caregiver_support: "Pflegepersonenunterstützung",
          ...
          adolescents_cbt_core: "KVT-Kernserie für Jugendliche",
  ...
  it: {
    translation: {
      ...
      quick_actions: {
        ...
        therapeutic_forms: { title: "Moduli Terapeutici", description: "Fogli di lavoro per la pratica personale" },
      ...
      chat: {
        ...
        thinking: "Pensando...",
        wait: { preparing: "Preparazione della risposta…", checking_context: "Verifica del contesto della conversazione…", still_working: "Sto ancora lavorando — non serve inviare di nuovo." },
        delivery: { saving: "Salvataggio…", sent: "Inviato e salvato", failed: "Non salvato — puoi riprovare", failed_title: "Messaggio non salvato", failed_description: "La bozza è stata ripristinata. Prova a inviarla di nuovo." },
        session_start: { failed_title: "Impossibile avviare la sessione", failed_description: "Il messaggio iniziale non è stato salvato. Riprova ad avviare la sessione." },
        feedback: { prompt: "È stato utile?", helpful: "Utile", not_helpful: "Non utile", thanks: "Grazie per il feedback!" },
        voice: { record: "Registra", record_aria: "Registra bozza vocale", recording: "Registrazione", stop: "Ferma", stop_aria: "Ferma registrazione", ready: "Bozza vocale pronta", play: "Riproduci", play_aria: "Riproduci registrazione", transcribe: "Trascrivi", transcribe_aria: "Trascrivi registrazione", transcribing: "Trascrizione…", delete: "Elimina", delete_aria: "Elimina registrazione" },
        experiment_metrics: { open: "Registra i risultati dell’esperimento", title: "Risultati dell’esperimento", anxiety_before: "Ansia prima", anxiety_after: "Ansia dopo", belief_after: "Forza della convinzione dopo", outcome: "Cosa è successo nella pratica?", learning: "Cosa hai imparato dalla differenza?", save: "Salva risultati", saving: "Salvataggio…", saved: "Risultati salvati", failed: "Salvataggio non riuscito. Il testo è ancora qui." },
      ...
      journeys: {
        ...
        premium: {
          eyebrow: "La tua pratica guidata",
          hero_description: "Scegli un percorso calmo e strutturato e procedi con un passo pratico alla volta.",
          back_aria: "Torna alla home",
          summary_aria: "Riepilogo percorsi",
          stat_available: "Disponibili",
          stat_active: "Attivi",
          stat_completed: "Completati",
          loading: "Preparazione dei tuoi percorsi...",
          load_error_title: "Impossibile caricare i tuoi percorsi",
          load_error_description: "I tuoi progressi sono al sicuro. Controlla la connessione e riprova.",
          retry: "Riprova",
          start_error: "Impossibile avviare il percorso. Riprova.",
          starting: "Avvio...",
          empty_available_description: "I nuovi percorsi guidati appariranno qui quando saranno disponibili.",
          empty_active_description: "Scegli un percorso disponibile quando ti senti pronto.",
          empty_completed_description: "I percorsi completati saranno raccolti qui come traccia della tua pratica.",
          gentle_pace: "Procedi al tuo ritmo: ogni passo conta.",
          card_badge: "Percorso guidato",
          explore: "Esplora percorsi",
          detail_eyebrow: "Il tuo percorso",
          roadmap_description: "Completa il passo attuale per sbloccare con calma quello successivo.",
        ...
        categories: {
          anxiety: "Supporto per l'ansia",
          depression: "Supporto per l'umore",
          stress: "Sollievo dallo stress",
          distress_tolerance: "Tolleranza al disagio",
          emotion_regulation: "Regolazione emotiva",
          mindfulness: "Consapevolezza",
          other: "Crescita personale"
        },
        difficulties: {
          beginner: "Delicato",
          intermediate: "In sviluppo",
          advanced: "Avanzato"
        },
        card: {
          days: "giorni",
          ...
          continue_journey: "Continua",
          view_details: "Vedi dettagli",
          details_aria: "Dettagli del percorso"
        },
        detail: {
          what_youll_gain: "Cosa svilupperai",
          journey_steps: "Passi del percorso",
          day: "Giorno",
          play_game: "Apri pratica",
          current_step: "Attuale",
          locked_step: "Bloccato",
          completed_step: "Completato",
          reflection_placeholder: "Scrivi qualche parola se vuoi",
          reflection_hint: "Facoltativo e privato nel tuo account.",
          saving: "Salvataggio...",
          mark_complete: "Completa passo",
          save_error: "Impossibile salvare questo passo. I progressi precedenti sono al sicuro; riprova.",
          close_aria: "Chiudi dettagli del percorso"
        }
      },
      mood_tracker: {
        ...
        analytics: {
          ...
          range_last_2_weeks: "Ultime 2 settimane",
          range_last_month: "Ultimo mese",
          range_last_3_months: "Ultimi 3 mesi",
          date_range: "Intervallo di date",
          average_mood: "Umore medio",
          average_stress: "Stress medio",
          no_data_yet: "Nessun dato disponibile",
          trend: "Tendenza",
          better: "Migliore",
          shift: "Cambiamento",
          steady: "Stabile",
          mood_stress_levels: "Livelli di umore e stress",
          mood_series: "Umore (1–5)",
          stress_series: "Stress (1–10)",
          energy_intensity: "Energia e intensità",
          energy: "Energia",
          intensity: "Intensità",
          start_tracking: "Inizia a monitorare l’umore per vedere l’analisi dei fattori",
          triggers_title: "Fattori dell’umore",
          triggers_subtitle: "Ciò che influisce negativamente sul tuo umore",
          no_trigger_data: "Nessun dato sui fattori",
          boosters_title: "Miglioratori dell’umore",
          boosters_subtitle: "Attività che migliorano il tuo umore",
          no_activity_data: "Nessun dato sulle attività",
          emotional_patterns: "Schemi emotivi",
          emotional_patterns_subtitle: "Emozioni provate più frequentemente",
          no_emotion_data: "Nessun dato sulle emozioni",
          average_mood_value: "Umore medio: {{value}}/5",
          times_count: "{{count}} volte"
        },
        form: {
      ...
      goal_coach_wizard: {
        ...
        smart_relevant_placeholder: "Rilevante: Perché questo obiettivo conta adesso?",
      ...
      exercise_view: {
        ...
        close: "Chiudi",
        about: "Informazioni sull’esercizio",
        guided_visualization: "Visualizzazione guidata",
        video_demo: "Dimostrazione video",
        audio_guide: "Guida audio",
        audio_unsupported: "Il browser non supporta l’elemento audio.",
        helps_with: "Aiuta con",
        guided_audio: "Audio guidato",
        guided_audio_description: "Segui la guida audio narrata professionalmente per questo esercizio.",
        step_guide: "Guida passo passo",
        step_duration: "Durata: {{seconds}} secondi",
        instructions: "Istruzioni",
        instructions_soon: "Le istruzioni appariranno presto qui.",
        choose_duration: "Scegli la durata",
        minutes_short: "{{count}} min",
        key_benefits: "Benefici principali",
        benefits_fallback: "Questo esercizio aiuta a migliorare il benessere mentale, ridurre lo stress e rafforzare la regolazione emotiva.",
        helpful_tips: "Suggerimenti utili",
        tips_fallback: "Pratica regolarmente. Trova un luogo tranquillo, inizia gradualmente e sii paziente con te stesso.",
        your_progress: "I tuoi progressi",
        times_completed: "Volte completato",
        minutes_practiced: "Minuti di pratica",
        last_practiced: "Ultima pratica: {{date}}",
      ...
      therapeutic_forms: {
        card_title: "Moduli Terapeutici",
        card_subtitle: "Fogli di lavoro per la pratica personale",
        page_title: "Moduli Terapeutici",
        page_subtitle: "Sfoglia e scarica fogli di lavoro per la pratica personale",
        filter_audience: "Pubblico",
        ...
        audience: {
          all: "Tutti i pubblici",
          children: "Bambini",
          adolescents: "Adolescenti",
          adults: "Adulti",
          older_adults: "Anziani",
        },
        category: {
          all: "Tutte le categorie",
          thought_records: "Registri dei pensieri",
          cognitive_distortions: "Distorsioni cognitive",
          emotional_regulation: "Regolazione emotiva",
          behavioral_activation: "Attivazione comportamentale",
          anxiety_tools: "Strumenti per l'ansia",
          depression_tools: "Strumenti per la depressione",
          anger_management: "Gestione della rabbia",
          social_skills: "Abilità sociali",
          sleep: "Sonno",
          goals_and_values: "Obiettivi e valori",
          parent_guidance: "Guida genitoriale",
          caregiver_support: "Supporto ai caregiver",
          ...
          adolescents_cbt_core: "CBT di base per adolescenti",
  ...
  pt: {
    translation: {
      ...
      quick_actions: {
        ...
        therapeutic_forms: { title: "Formulários Terapêuticos", description: "Folhas de trabalho para prática pessoal" },
      ...
      chat: {
        ...
        thinking: "Pensando...",
        wait: { preparing: "Preparando sua resposta…", checking_context: "Revisando o contexto da conversa…", still_working: "Ainda estou trabalhando — não é preciso reenviar." },
        delivery: { saving: "Salvando…", sent: "Enviado e salvo", failed: "Não foi salvo — tente novamente", failed_title: "Mensagem não salva", failed_description: "Seu rascunho foi restaurado. Tente enviá-lo novamente." },
        session_start: { failed_title: "Não foi possível iniciar a sessão", failed_description: "A mensagem inicial não foi salva. Tente iniciar a sessão novamente." },
        feedback: { prompt: "Isso foi útil?", helpful: "Útil", not_helpful: "Não foi útil", thanks: "Obrigado pelo feedback!" },
        voice: { record: "Gravar", record_aria: "Gravar rascunho de voz", recording: "Gravando", stop: "Parar", stop_aria: "Parar gravação", ready: "Rascunho de voz pronto", play: "Reproduzir", play_aria: "Reproduzir gravação", transcribe: "Transcrever", transcribe_aria: "Transcrever gravação", transcribing: "Transcrevendo…", delete: "Excluir", delete_aria: "Excluir gravação" },
        experiment_metrics: { open: "Registrar resultados do experimento", title: "Resultados do experimento", anxiety_before: "Ansiedade antes", anxiety_after: "Ansiedade depois", belief_after: "Força da crença depois", outcome: "O que aconteceu na prática?", learning: "O que você aprendeu com a diferença?", save: "Salvar resultados", saving: "Salvando…", saved: "Resultados salvos", failed: "Não foi possível salvar. Seu texto continua aqui." },
      ...
      journeys: {
        ...
        premium: {
          eyebrow: "Sua prática guiada",
          hero_description: "Escolha um caminho calmo e estruturado e avance um passo prático de cada vez.",
          back_aria: "Voltar ao início",
          summary_aria: "Resumo das jornadas",
          stat_available: "Disponíveis",
          stat_active: "Ativas",
          stat_completed: "Concluídas",
          loading: "Preparando suas jornadas...",
          load_error_title: "Não foi possível carregar suas jornadas",
          load_error_description: "Seu progresso está seguro. Verifique a conexão e tente novamente.",
          retry: "Tentar novamente",
          start_error: "Não foi possível iniciar a jornada. Tente novamente.",
          starting: "Iniciando...",
          empty_available_description: "Novos caminhos guiados aparecerão aqui quando estiverem disponíveis.",
          empty_active_description: "Escolha uma jornada disponível quando se sentir pronto.",
          empty_completed_description: "As jornadas concluídas serão reunidas aqui como registro da sua prática.",
          gentle_pace: "Avance no seu ritmo — cada passo conta.",
          card_badge: "Caminho guiado",
          explore: "Explorar jornadas",
          detail_eyebrow: "Sua jornada",
          roadmap_description: "Conclua o passo atual para desbloquear com calma o próximo.",
        ...
        categories: {
          anxiety: "Apoio para ansiedade",
          depression: "Apoio para baixo humor",
          stress: "Alívio do estresse",
          distress_tolerance: "Tolerância ao sofrimento",
          emotion_regulation: "Regulação emocional",
          mindfulness: "Atenção plena",
          other: "Crescimento pessoal"
        },
        difficulties: {
          beginner: "Suave",
        ...
        card: {
          ...
          details_aria: "Detalhes da jornada"
        },
        detail: {
          what_youll_gain: "O que você vai desenvolver",
          journey_steps: "Passos da jornada",
          day: "Dia",
          play_game: "Abrir prática",
          current_step: "Atual",
          locked_step: "Bloqueado",
          completed_step: "Concluído",
          reflection_placeholder: "Escreva algumas palavras se quiser",
          reflection_hint: "Opcional e privado na sua conta.",
          saving: "Salvando...",
          mark_complete: "Concluir passo",
          save_error: "Não foi possível salvar este passo. Seu progresso anterior está seguro; tente novamente.",
          close_aria: "Fechar detalhes da jornada"
        }
      },
      mood_tracker: {
        ...
        analytics: {
          ...
          range_last_2_weeks: "Últimas 2 semanas",
          range_last_month: "Último mês",
          range_last_3_months: "Últimos 3 meses",
          date_range: "Intervalo de datas",
          average_mood: "Humor médio",
          average_stress: "Estresse médio",
          no_data_yet: "Ainda não há dados",
          trend: "Tendência",
          better: "Melhor",
          shift: "Mudança",
          steady: "Estável",
          mood_stress_levels: "Níveis de humor e estresse",
          mood_series: "Humor (1–5)",
          stress_series: "Estresse (1–10)",
          energy_intensity: "Energia e intensidade",
          energy: "Energia",
          intensity: "Intensidade",
          start_tracking: "Comece a acompanhar seu humor para ver a análise de fatores",
          triggers_title: "Fatores do humor",
          triggers_subtitle: "O que afeta negativamente seu humor",
          no_trigger_data: "Ainda não há dados de fatores",
          boosters_title: "Impulsionadores do humor",
          boosters_subtitle: "Atividades que melhoram seu humor",
          no_activity_data: "Ainda não há dados de atividades",
          emotional_patterns: "Padrões emocionais",
          emotional_patterns_subtitle: "Emoções sentidas com mais frequência",
          no_emotion_data: "Ainda não há dados de emoções",
          average_mood_value: "Humor médio: {{value}}/5",
          times_count: "{{count}} vezes"
        },
        form: {
      ...
      goal_coach_wizard: {
        ...
        smart_relevant_placeholder: "Relevante: Por que esta meta importa agora?",
      ...
      exercise_view: {
        ...
        about: "Sobre este exercício",
        guided_visualization: "Visualização guiada",
        video_demo: "Demonstração em vídeo",
        audio_guide: "Guia de áudio",
        audio_unsupported: "Seu navegador não suporta o elemento de áudio.",
        helps_with: "Ajuda com",
        guided_audio: "Áudio guiado",
        guided_audio_description: "Acompanhe a orientação em áudio narrada profissionalmente para este exercício.",
        step_guide: "Guia passo a passo",
        step_duration: "Duração: {{seconds}} segundos",
        instructions: "Instruções",
        instructions_soon: "As instruções aparecerão aqui em breve.",
        choose_duration: "Escolher duração",
        minutes_short: "{{count}} min",
        key_benefits: "Principais benefícios",
        benefits_fallback: "Este exercício ajuda a melhorar o bem-estar mental, reduzir o estresse e fortalecer a regulação emocional.",
        helpful_tips: "Dicas úteis",
        tips_fallback: "Pratique regularmente. Encontre um lugar tranquilo, comece devagar e tenha paciência consigo.",
        your_progress: "Seu progresso",
        times_completed: "Vezes concluído",
        minutes_practiced: "Minutos praticados",
        last_practiced: "Última prática: {{date}}",
      ...
      therapeutic_forms: {
        card_title: "Formulários Terapêuticos",
        card_subtitle: "Folhas de trabalho para prática pessoal",
        page_title: "Formulários Terapêuticos",
        page_subtitle: "Navegue e baixe folhas de trabalho para prática pessoal",
        filter_audience: "Público",
        filter_category: "Categoria",
        filter_all: "Todos",
        open_form: "Abrir",
        ...
        category: {
          ...
          thought_records: "Registros de pensamentos",
          cognitive_distortions: "Distorções cognitivas",
          emotional_regulation: "Regulação emocional",
          behavioral_activation: "Ativação comportamental",
          anxiety_tools: "Ferramentas de ansiedade",
          depression_tools: "Ferramentas de depressão",
          anger_management: "Gerenciamento de raiva",
          social_skills: "Habilidades sociais",
          sleep: "Sono",
          goals_and_values: "Objetivos e valores",
          parent_guidance: "Orientação para pais",
          caregiver_support: "Apoio ao cuidador",
          ...
          adolescents_cbt_core: "TCC central para adolescentes",
