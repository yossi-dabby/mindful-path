...
export default function InlineConsentBanner({ onAccept }) {
    ...
    return (_jsx(Card, { "data-testid": "consent-banner", className: "border-0 mb-4", style: {
            borderRadius: '20px',
            background: 'linear-gradient(145deg, rgba(255, 243, 224, 0.95) 0%, rgba(255, 237, 213, 0.9) 100%)',
            backdropFilter: 'blur(8px)',
            border: '1px solid rgba(251, 191, 36, 0.3)',
            boxShadow: '0 4px 12px rgba(251, 191, 36, 0.15)'
        }, children: _jsx("div", { className: "p-4 md:p-5", children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "w-8 h-8 flex items-center justify-center flex-shrink-0 mt-0.5", style: {
                            borderRadius: '12px',
                            background: 'linear-gradient(145deg, rgba(251, 191, 36, 0.2) 0%, rgba(245, 158, 11, 0.2) 100%)'
                        }, children: _jsx(Info, { className: "w-4 h-4", style: { color: '#D97706' } }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("h3", { className: "text-sm md:text-base font-semibold mb-1.5", style: { color: '#78350F' }, children: currentProfile.title }), _jsx("p", { className: "text-xs md:text-sm leading-relaxed mb-3", style: { color: '#92400E' }, children: currentProfile.message }), _jsxs("a", { href: "https://base44.com/safety-faq", target: "_blank", rel: "noopener noreferrer", className: "text-xs flex items-center gap-1 mb-3 hover:underline", style: { color: '#D97706' }, children: ["Learn more about safety profiles", _jsx(ExternalLink, { className: "w-3 h-3" })] }), _jsx(Button, { onClick: handleAccept, "data-testid": "consent-accept", size: "sm", className: "text-white font-medium", style: {
                                    borderRadius: '14px',
