...
export default function InlineRiskPanel({ onDismiss }) {
    ...
    return (_jsx(Card, { "data-testid": "inline-risk-panel", className: "border-0 mb-4", style: {
            borderRadius: '20px',
            background: 'linear-gradient(145deg, rgba(254, 242, 242, 0.98) 0%, rgba(254, 226, 226, 0.95) 100%)',
            backdropFilter: 'blur(8px)',
            border: '2px solid rgba(239, 68, 68, 0.3)',
            boxShadow: '0 4px 12px rgba(239, 68, 68, 0.2)'
        }, children: _jsx("div", { className: "p-4 md:p-5", children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("div", { className: "w-10 h-10 flex items-center justify-center flex-shrink-0 mt-0.5", style: {
                            borderRadius: '14px',
                            background: 'linear-gradient(145deg, rgba(239, 68, 68, 0.2) 0%, rgba(220, 38, 38, 0.2) 100%)'
                        }, children: _jsx(AlertTriangle, { className: "w-5 h-5", style: { color: '#DC2626' } }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("h3", { className: "text-base md:text-lg font-semibold mb-2", style: { color: '#7F1D1D' }, children: s.title }), _jsx("p", { className: "text-sm md:text-base leading-relaxed mb-4", style: { color: '#991B1B' }, children: s.body }), _jsxs("div", { className: "space-y-2 mb-4 text-sm", children: [_jsxs("div", { className: "flex items-center gap-2 p-2 rounded-lg", style: { backgroundColor: 'rgba(255, 255, 255, 0.6)' }, children: [_jsx(Phone, { className: "w-4 h-4 flex-shrink-0", style: { color: '#DC2626' } }), _jsxs("div", { children: [_jsxs("span", { className: "font-medium", style: { color: '#7F1D1D' }, children: [s.hotlineLabel, ":"] }), _jsx("span", { className: "ml-2", style: { color: '#991B1B' }, children: s.hotlineNumber })] })] }), _jsxs("div", { className: "flex items-center gap-2 p-2 rounded-lg", style: { backgroundColor: 'rgba(255, 255, 255, 0.6)' }, children: [_jsx(MessageSquare, { className: "w-4 h-4 flex-shrink-0", style: { color: '#DC2626' } }), _jsxs("div", { children: [_jsxs("span", { className: "font-medium", style: { color: '#7F1D1D' }, children: [s.textLabel, ":"] }), _jsx("span", { className: "ml-2", style: { color: '#991B1B' }, children: s.textNumber })] })] }), _jsxs("div", { className: "flex items-center gap-2 p-2 rounded-lg", style: { backgroundColor: 'rgba(255, 255, 255, 0.6)' }, children: [_jsx(Phone, { className: "w-4 h-4 flex-shrink-0", style: { color: '#DC2626' } }), _jsxs("div", { children: [_jsxs("span", { className: "font-medium", style: { color: '#7F1D1D' }, children: [s.emergencyLabel, ":"] }), _jsx("span", { className: "ml-2", style: { color: '#991B1B' }, children: s.emergencyNumber })] })] })] }), _jsx("p", { className: "text-xs mb-3", style: { color: '#991B1B', opacity: 0.8 }, children: s.disclaimer }), _jsx(Button, { onClick: handleDismiss, "data-testid": "risk-panel-dismiss", className: "w-full md:w-auto text-white font-medium", style: {
                                    borderRadius: '14px',
