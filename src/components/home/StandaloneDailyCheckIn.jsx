            ...
            <motion.div
              ...
              <div className="grid grid-cols-5 gap-1 sm:gap-2 md:gap-3">
                ...
                <button
                  ...
                  }} className="text-xs font-medium normal-case flex flex-col items-center justify-center sm:p-2 md:p-4 transition-all hover:scale-105 hover:opacity-80 px-1 py-1"
