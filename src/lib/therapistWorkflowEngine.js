...
export function buildPlannerFirstInstructions() {
  ...
  return [
    ...
    '  2. If the user requests exactly ONE action or step, provide exactly one concrete action.',
    '     Do NOT add alternatives, examples, optional variants, or hidden additional steps,',
    '     and do NOT reinterpret one requested action as permission to provide a menu.',
