...
export function buildPlannerFirstInstructions() {
  ...
  return [
    ...
    '',
    'Apply this policy in every language whenever an intervention is otherwise permitted.',
    'The latest explicit user output constraint overrides inferred or default intervention formatting.',
    '',
    ...
    '  5. When the user corrects an earlier constraint, follow the latest explicit constraint;',
