...
export default function Progress() {
  ...
  return (
    <div className="p-4 md:p-8 pb-32 md:pb-24 max-w-7xl mx-auto w-full" style={{ minHeight: '100dvh', background: 'linear-gradient(165deg, #D4EDE8 0%, #BDE0D9 30%, #A8D4CB 60%, #9ECCC2 100%)' }}>
      {/* Header */}
