...
export default function Chat() {
  ...
  return (
    <>
      ...
      <div className="bg-teal-100 flex relative"
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        {/* Messages Area */}
        <div className="bg-teal-100 text-slate-50 px-3 flex-1 min-h-0 overflow-hidden flex flex-col" style={{ backgroundColor: 'transparent' }}>
          {!currentConversationId ?
