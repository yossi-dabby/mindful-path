  ...
  return (
    <>
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <div className="bg-teal-50 text-teal-600 px-3 rounded-2xl md:px-6 md:pt-3 md:pb-3 relative border-t border-border/70 backdrop-blur-xl shadow-[var(--shadow-md)]" style={{
            zIndex: 50
          }}>
