...
describe('Phase 9 — B. Flag isolation', () => {
  ...
  it('THERAPIST_UPGRADE_FLAGS has exactly 9 flags (Phase 10 adds THERAPIST_UPGRADE_FORMULATION_LED_ENABLED)', () => {
...
describe('Phase 9 — M. Final Stage 2 readiness proof', () => {
  ...
  it('all 9 feature flags are present and all default to false', () => {
    expect(Object.keys(THERAPIST_UPGRADE_FLAGS)).toHaveLength(9);
