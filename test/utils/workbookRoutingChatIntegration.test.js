...
describe('workbookRoutingChatIntegration.test.js', () => {
  it.skipIf(!THERAPEUTIC_FORMS_CONTENT_AVAILABLE)('routes English workbook requests to the installed adolescents package and keeps unsupported languages null', () => {
  ...
  it.skipIf(!THERAPEUTIC_FORMS_CONTENT_AVAILABLE)('supports English context-aware workbook routing and keeps unsupported languages null', () => {
